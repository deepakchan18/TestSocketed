    ...
    render() {
        ...
        return (
            ...
            <Text style={{alignItems:'center', fontSize:65, fontWeight:'bold', color:'#571dde', marginTop: 85}} >Socketed</Text>
                ...
                { this.state.isValidEmail ? null : <Text style={{marginTop: 0, fontSize: 14, color: '#ff1100', alignItems:'center', justifyContent:'center'}} >Email is empty or badly formatted.</Text> }

                <TextInput
                    style={{ backgroundColor: '#e5e5e5', width: WIDTH - 100, height: 60,borderRadius:35,paddingLeft:45, marginTop: 10, fontSize: 18, }}
                ...
                />
                <TouchableOpacity style={{ marginTop: -40,right: -125 }} onPress = {()=> this.setState({secureTextEntry: !this.state.secureTextEntry})} >
                    {this.state.secureTextEntry ? 
                        <Feather name="eye-off" color="grey" size={20} /> : 
                        <Feather name="eye" color="grey" size={20} /> }
                </TouchableOpacity>

                {this.state.isValidPass ? null : <Text style={{marginTop: 20, fontSize: 14, color: '#ff1100', alignItems:'center', justifyContent:'center'}} >Password must be atleast 8 characters.</Text>}

                <TextInput
                    style={{ backgroundColor: '#e5e5e5', width: WIDTH - 100, height: 60,borderRadius:35,paddingLeft:45, marginTop: 30, fontSize: 18, }}
                ...
                />
                <TouchableOpacity style={{ marginTop: -40, right: -125 }} onPress = {()=> this.setState({confSecureTextEntry: !this.state.confSecureTextEntry})} >
                    {this.state.confSecureTextEntry ? 
                        <Feather name="eye-off" color="grey" size={20} /> : 
                        <Feather name="eye" color="grey" size={20} /> }
                </TouchableOpacity>

                { this.state.isValidConfPass ? null : <Text style={{marginTop: 20, fontSize: 14, color: '#ff1100', alignItems:'center', justifyContent:'center'}} >Passwords are not same.</Text> }

                <Text style={{ textAlign: 'center' ,color:'#858585', marginTop: 30 }} >By signingUp you are accepting our</Text>
